...
export function DesignTokensDemo() {
    const colorVariables = [
        {name: '--av-background', description: 'Background color', category: 'Base'},
        {name: '--av-foreground', description: 'Foreground/text color', category: 'Base'},
        {name: '--av-primary', description: 'Primary button color (#2668C5)', category: 'Primary'},
        {name: '--av-primary-foreground', description: 'Primary button text', category: 'Primary'},
        {name: '--av-secondary', description: 'Secondary button background', category: 'Secondary'},
        {
        ...
        {name: '--av-destructive-foreground', description: 'Destructive text', category: 'Status'},
        {name: '--av-success', description: 'Success color (#9BC225)', category: 'Status'},
        {name: '--av-warning', description: 'Warning color (#FFC107)', category: 'Status'},
        {name: '--av-info', description: 'Info color (#408BEA)', category: 'Status'},
        {name: '--av-critical', description: 'Critical color (#FF810D)', category: 'Status'},
        {name: '--av-border', description: 'Border color', category: 'Border'},
        {name: '--av-input', description: 'Input border color', category: 'Border'},
        {name: '--av-ring', description: 'Focus ring color', category: 'Border'},
    ]
    ...
    return (
        <section className="demo-section">
            ...
            <p className="demo-description">
                Visual reference for all CSS custom properties (variables) used in the design system.
            </p>
            ...
            <div className="space-y-12">
                                    ...
                                    >
                                        ...
                                        <div className="text-right">
                                            <div
                                                ...
                                                style={{
                                                    backgroundColor: `hsl(var(${variable.name}))`,
                                                    color: variable.name.includes('foreground') ? 'inherit' : undefined,
                                                }}
                                            >
                                                Preview
                                            </div>
                ...
                {/* Spacing Variables */}
                <div>
                    <h3 className="text-2xl font-semibold mb-6">Spacing & Size Variables</h3>
                    <div className="grid gap-4">
                ...
                <div>
                    <h3 className="text-2xl font-semibold mb-6">Tailwind Utility Classes</h3>
                    <div className="space-y-6">
                        <div>
                            <h4 className="text-lg font-medium mb-4 text-gray-700">Background Colors</h4>
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                {[
                                    ...
                                    <div key={className} className="border rounded-lg p-4">
                                        ...
                                        <code className="text-xs font-mono text-gray-600">{className}</code>
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div>
                            <h4 className="text-lg font-medium mb-4 text-gray-700">Text Colors</h4>
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                {[
                                    'text-foreground',
                                    'text-primary',
                        ...
                        <div>
                            <h4 className="text-lg font-medium mb-4 text-gray-700">Border Colors</h4>
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                {[
                                    'border-border',
                                    'border-input',
                                    ...
                                    (className) => (
                                        <div key={className} className="border rounded-lg p-4">
                                            <div className={`w-full h-16 rounded border-4 ${className} mb-2`}/>
                                            <code className="text-xs font-mono text-gray-600">{className}</code>
                                        </div>
                                    )
                                )}
                        ...
                        <div>
                            <h4 className="text-lg font-medium mb-4 text-gray-700">Border Radius</h4>
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                {[
                                    'rounded-none',
                                    'rounded-sm',
                                    ...
                                    <div key={className} className="border rounded-lg p-4">
                                        <div className={`w-full h-16 bg-primary ${className} mb-2`}/>
                                        <code className="text-xs font-mono text-gray-600">{className}</code>
                                    </div>
                                ))}
                            </div>
                        ...
                        <div>
                            <h4 className="text-lg font-medium mb-4 text-gray-700">Spacing</h4>
                            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                {['p-2', 'p-4', 'p-6', 'p-8', 'm-2', 'm-4', 'm-6', 'm-8'].map((className) => (
                                    <div key={className} className="border rounded-lg p-4">
                                        ...
                                        <code className="text-xs font-mono text-gray-600 block mt-2">{className}</code>
                                    </div>
                                ))}
                            </div>
                        </div>
                ...
                <div>
                    ...
                    <p className="text-gray-600 mb-6">
                        CSS doesn&apos;t directly support gradients on borders, but here are several techniques to achieve gradient border effects with Tailwind CSS.
                    </p>
                    <div className="space-y-8">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mb-4">
                                Uses a gradient background on an outer container with padding to simulate a border. Works with border-radius.
                            </p>
  ...
  <div className="bg-background rounded-lg p-6">
    Content
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-600 mb-4">
                                Uses CSS border-image property. Note: Does not work with border-radius.
                            </p>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
