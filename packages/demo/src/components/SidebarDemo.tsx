    ...
    <section className="demo-section">
      ...
      <div className="space-y-8">
        <div className="demo-item">
          <h3>Full Sidebar Example</h3>
          <p className="text-sm text-gray-600 mb-4">
            A complete sidebar with header, grouped navigation sections, badges, tags, and footer.
          </p>
        ...
        <div className="demo-item">
          <h3>Sidebar with Icons Only</h3>
          <p className="text-sm text-gray-600 mb-4">
            Compact sidebar showing only icons. Hover to see tooltips.
          </p>
        ...
        <div className="demo-item">
          <h3>Sidebar with Badges</h3>
          <p className="text-sm text-gray-600 mb-4">
            Navigation items with counter badges and &quot;NEW&quot; tags.
          </p>
          <div className="h-[400px] border rounded-lg overflow-hidden flex">
            <SidebarProvider>
              <Sidebar collapsible="none">
        ...
        <div className="demo-item">
          <h3>Sidebar with Sections</h3>
          <p className="text-sm text-gray-600 mb-4">Organized navigation with labeled sections.</p>
          <div className="h-[400px] border rounded-lg overflow-hidden flex">
            <SidebarProvider>
              <Sidebar collapsible="none">
                <SidebarContent>
